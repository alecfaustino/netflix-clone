...
export default async function MoviesByGenrePage({ searchParams }: { searchParams: { genre_id: string, genre_name: string } }) {
  ...
  return (
    ...
    <main>
      <Typography variant="h4" className='text-center'>{`Movies in ${genre_name}`}</Typography>
